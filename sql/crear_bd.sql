...
ALTER TABLE IF EXISTS public.accede DROP CONSTRAINT IF EXISTS accede_fk;

ALTER TABLE IF EXISTS public.administradores DROP CONSTRAINT IF EXISTS administrador_fk;

ALTER TABLE IF EXISTS public.alumnos DROP CONSTRAINT IF EXISTS alumno_fk;

ALTER TABLE IF EXISTS public.ciclos_escolares_materias DROP CONSTRAINT IF EXISTS ciclos_escolares_materias_id_ciclo_escolar_fkey;

ALTER TABLE IF EXISTS public.ciclos_escolares_materias DROP CONSTRAINT IF EXISTS ciclos_escolares_materias_id_plan_materia_fkey;

ALTER TABLE IF EXISTS public.enlista DROP CONSTRAINT IF EXISTS enlista_id_grupo_fkey;

ALTER TABLE IF EXISTS public.enlista DROP CONSTRAINT IF EXISTS enlista_id_ivd_fkey;

ALTER TABLE IF EXISTS public.grupos DROP CONSTRAINT IF EXISTS grupos_id_profesor_fkey;

ALTER TABLE IF EXISTS public.grupos DROP CONSTRAINT IF EXISTS grupos_id_salon_fkey;

ALTER TABLE IF EXISTS public.grupos_ciclos_materias DROP CONSTRAINT IF EXISTS grupos_ciclos_materias_id_ciclo_escolar_materia_fkey;

ALTER TABLE IF EXISTS public.grupos_ciclos_materias DROP CONSTRAINT IF EXISTS grupos_ciclos_materias_id_grupo_fkey;

ALTER TABLE IF EXISTS public.grupos_horarios DROP CONSTRAINT IF EXISTS grupos_horarios_id_grupo_fkey;

ALTER TABLE IF EXISTS public.planes_estudios DROP CONSTRAINT IF EXISTS planes_estudios_id_carrera_fkey;

ALTER TABLE IF EXISTS public.planes_materias DROP CONSTRAINT IF EXISTS planes_materias_id_materia_fkey;

ALTER TABLE IF EXISTS public.planes_materias DROP CONSTRAINT IF EXISTS planes_materias_id_plan_fkey;

ALTER TABLE IF EXISTS public.profesores_disponibilidad DROP CONSTRAINT IF EXISTS profesores_disponibilidad_id_ciclo_escolar_fkey;

ALTER TABLE IF EXISTS public.profesores_disponibilidad DROP CONSTRAINT IF EXISTS profesores_disponibilidad_id_profesor_fkey;

ALTER TABLE IF EXISTS public.profesores_materias DROP CONSTRAINT IF EXISTS fk_ciclo_materia;

ALTER TABLE IF EXISTS public.profesores_materias DROP CONSTRAINT IF EXISTS fk_profesor;

ALTER TABLE IF EXISTS public.requisitos DROP CONSTRAINT IF EXISTS materia_fk_2;

ALTER TABLE IF EXISTS public.salones_disponibilidad DROP CONSTRAINT IF EXISTS salones_disponibilidad_id_ciclo_escolar_fkey;

ALTER TABLE IF EXISTS public.salones_disponibilidad DROP CONSTRAINT IF EXISTS salones_disponibilidad_id_salon_fkey;

ALTER TABLE IF EXISTS public.solicitudes_cambio DROP CONSTRAINT IF EXISTS solicitudes_cambio_id_ciclo_escolar_fkey;

ALTER TABLE IF EXISTS public.solicitudes_cambio DROP CONSTRAINT IF EXISTS solicitudes_cambio_id_ivd_fkey;

ALTER TABLE IF EXISTS public.solicitudes_cambio DROP CONSTRAINT IF EXISTS solicitudes_cambio_id_materia_fkey;



DROP TABLE IF EXISTS public.accede;
...
DROP TABLE IF EXISTS public.ciclos_escolares;
...
(
    ...
    CONSTRAINT ciclos_escolares_pk UNIQUE (id_ciclo_escolar)
);

DROP TABLE IF EXISTS public.ciclos_escolares_materias;
...
DROP TABLE IF EXISTS public.grupos_ciclos_materias;
...
DROP TABLE IF EXISTS public.grupos_horarios;
...
DROP TABLE IF EXISTS public.planes_estudios;
...
DROP TABLE IF EXISTS public.planes_materias;
...
DROP TABLE IF EXISTS public.profesores_disponibilidad;
...
DROP TABLE IF EXISTS public.profesores_materias;
...
(
    ...
    CONSTRAINT profesores_materias_pkey PRIMARY KEY (id_profesor_materia)
);
...
DROP TABLE IF EXISTS public.salones_disponibilidad;
...
DROP TABLE IF EXISTS public.solicitudes_cambio;
...
ALTER TABLE IF EXISTS public.planes_materias
    ADD CONSTRAINT planes_materias_id_plan_fkey FOREIGN KEY (id_plan_estudio)
...
ALTER TABLE IF EXISTS public.profesores_materias
    ADD CONSTRAINT fk_ciclo_materia FOREIGN KEY (id_ciclo_escolar_materia)
    REFERENCES public.ciclos_escolares_materias (id_ciclo_escolar_materia) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE;
